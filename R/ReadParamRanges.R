...
################################################################################
ReadParamRanges <- function(ParamRanges.fname="ParamRanges.txt" # It has to have a row with the header
                                 ) {

  # Reading the file with the Range of the paramters
  ParamRanges <-  ReadParamFile(file=ParamRanges.fname)
...
#ReadParamRanges("./PSO/ParamRanges.txt")
